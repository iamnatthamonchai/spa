odoo.define('app_odoo_customize.UserMenu', function (require) {
    ...
    //避免错误，要再定义
    var documentation_url = 'https://plug.zabdoo.com';
    var documentation_dev_url = 'https://plug.zabdoo.com';
    var support_url = 'https://plug.zabdoo.com';
    var account_title = 'My Account';
    var account_url = 'https://plug.zabdoo.com';
