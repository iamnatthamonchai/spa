...
# author: 广州尚鹏，https://plug.zabdoo.com
# email: 300883@qq.com
# resource of Sunpop
# License AGPL-3.0 or later (http://www.gnu.org/licenses/agpl).

# Odoo12在线用户手册（长期更新）
# https://plug.zabdoo.com/documentation/user/12.0/en/index.html

# Odoo12在线开发者手册（长期更新）
# https://plug.zabdoo.com/documentation/12.0/index.html

# Odoo10在线中文用户手册（长期更新）
# https://plug.zabdoo.com/documentation/user/10.0/zh_CN/index.html

# Odoo10离线中文用户手册下载
# https://plug.zabdoo.com/odoo10_user_manual_document_offline/
# Odoo10离线开发手册下载-含python教程，jquery参考，Jinja2模板，PostgresSQL参考（odoo开发必备）
# https://plug.zabdoo.com/odoo10_developer_document_offline/
# description:
